...
## 目標
HMTL,CSS,JavaScriptの基礎が理解でき、扱えること
...
---
#### 2 centerDiv
300px四方のdivを画面の上部中央に表示してください。色は赤、画面幅が変わっても中央に移動するようにして下さい。
...
---
#### 5 bored
画面中央に表示された「I'm so bored」の文字をクリックすると「AWESOME!」に書き換わるプログラムを作成してください。文字は128px、色は赤。
...
---
#### 7 sumSequence
1からnまでの和をコンソールに出力するプログラムを作成してください。nはフォームに入力された値である。for文を使用してすること



---
#### 9 anchor
Yahoo Japanに繊維するリンクを3つ表示してください  
1つは同一のウィンドウ上で開くようにしてください  
1つは新しいタブで開くようにしてください  
1つはjavascriptのwindow.open()を使用して開くようにしてください


---
#### 10 countUp
ボタンを押すと画面に表示された数字が1つづつカウントアップされるプログラムを作成してください。カウントが3の倍数の時にあほっぽくなるようにしてください。
...
algo
	1. テキストフォームから入力された10進数を２進数に変換して表示するプログラムを作って下さい


	1. 1~20までのランダムな整数を10個配列に格納し、出力するプログラムを作って下さい


	1. 同じ数字が重複しないように改造して下さい
	2. 大きい順にソート（並び替え）して出力するよう改造して下さい
	3. 指定された数字があれば削除、なければ「error: Can't deleted」と出力するよう改造して下さい
	4. 

tagmake it100 nockmenujavascripthtmlcssweb
